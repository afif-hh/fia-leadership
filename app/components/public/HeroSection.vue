...
<template>
  <section class="grid grid-cols-1 lg:grid-cols-2 gap-space-8 items-center min-h-[716px] py-space-12" aria-labelledby="hero-heading">
    <div class="flex flex-col gap-space-6">
      <div class="inline-flex items-center gap-space-2 bg-surface-container-high text-primary-700 px-space-2 py-space-1 rounded-full font-label-mono text-label-mono w-max">
        <span class="material-symbols-outlined text-sm">science</span>
        <span>Evidence-Based Leadership</span>
      </div>
      <h1 id="hero-heading" class="font-display-lg text-display-lg text-ink-900 leading-tight" lang="en">
    ...
    <div class="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden border border-border bg-surface flex items-center justify-center">
      <div
