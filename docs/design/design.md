...
terbukti reusable — hanya _isinya_ yang diautorisasi ulang untuk institusi ini, bukan
...
_token nilai_ (warna, tipografi, spacing, shape, komponen); _aturan wajib_ interaksi/a11y tetap
...
dashboard — memprioritaskan _density terkendali_: cukup ruang untuk scanability tapi tidak boros,
